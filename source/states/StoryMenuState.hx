        ...
        override function update(elapsed:Float)
        {
                if(WeekData.weeksList.length < 1)
                {
                        ...
                        for (touch in FlxG.touches.justReleased())
                                if (touch.x < 80) mobileBack = true;
                        #end
                        if ((controls.BACK #if mobile || mobileBack #end) && !movedBack && !selectedWeek)
                        {
                ...
                if (!movedBack && !selectedWeek)
                {
                        ...
                        for (touch in FlxG.touches.justReleased())
                        {
                                ...
                                else if (touch.overlaps(rightArrow))
                                {
                                ...
                                {
                                        // Toque em um item de semana
                                        for (num => item in grpWeekText.members)
                                        {
                                                if (touch.overlaps(item))
                                                {
                                                        if (num == curWeek)
                                                                selectWeek(); // segundo toque confirma
                                                        else
                                                        {
                                                                curWeek = num;
                                                                changeWeek();
                ...
                var mobileBack:Bool = false;
                for (touch in FlxG.touches.justReleased())
                        if (touch.x < 80) mobileBack = true; // swipe/toque na borda esquerda = voltar
                #end
