...
class MainMenuState extends MusicBeatState
{
        ...
        override function update(elapsed:Float)
        {
                ...
                if (!selectedSomethin)
                {
                        ...
                        #if mobile
                        // Toque: seleciona e confirma o item tocado diretamente
                        ...
                        if (controls.ACCEPT #if !mobile || (FlxG.mouse.justPressed && allowMouse) #end)
                        {
        ...
        // Usado pelo toque mobile para confirmar o item atualmente selecionado
